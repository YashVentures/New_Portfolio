  ...
  return (
    <section id="services" className="services">
      <div className="container">
        ...
        >
          Specialized in scalable web and backend development using React, Next.js, Node.js and Python full-stack architectures—delivering robust solutions from design to deployment.
        </motion.p>
